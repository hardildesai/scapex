...
export default function LogisticsCTA(): JSX.Element {
  return (
    <section className="bg-[#faf8f4] py-24 px-6 md:px-10 text-center" id="logistics-contact">
      <div className="max-w-[660px] mx-auto">
        ...
        <Link
          ...
          className="inline-block bg-[#c8a84b] text-[#0d1b2e] font-mono font-extrabold text-[0.72rem] tracking-[0.14em] uppercase py-4 px-10 rounded-full hover:bg-[#d4b55a] transition-all duration-200 no-underline shadow-lg shadow-gold/15"
        >
