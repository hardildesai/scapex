      ...
      <div className="max-w-[1180px] mx-auto px-10 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-8 md:gap-12 pb-12">
          <div className="flex flex-col gap-4">
            <a href="/" aria-label="Scapex Home" className="inline-block">
              <span className="text-[1.25rem] font-extrabold text-white tracking-tight">Scapex</span>
            </a>
            <p className="text-[0.74rem] text-[#7b9bb8] leading-[1.7]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {footerLinks.map((col) => (
              <div key={col.heading}>
                <h4 className="text-[0.58rem] font-bold tracking-[0.15em] uppercase text-[#4a6a88] mb-4">
                  {col.heading}
                </h4>
        ...
        <div className="flex flex-wrap items-center justify-between py-5 gap-4">
          <p className="text-[0.67rem] text-[#4a6a88] tracking-wide">
